			...
			<div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
				<div className="md:flex md:justify-between">
					<div className="mb-6 md:mb-0">
						<div className="py-2 px-3 rounded-lg flex bg-stone-900/50 items-center">
						<Image src="/LogoDms.png" width={200} height={130} alt="Logo" className="h-12 w-auto" />
						<a href="/" className="flex items-center ">
							{/*<span className="self-center text-2xl text-[#D3D355] font-semibold whitespace-nowrap dark:text-white">
								Digitale Online Schule Freiburg
							</span>*/}
						</a>
